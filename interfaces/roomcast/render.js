...
function preloadImages(callback) { 
	...
	var images = [bg,'left_foot','right_foot','telescope1','telescope2','telescope3','telescope4','mfw'];
    var img;
    ...
    for (var i = 0; i < images.length; i++) {
        ...
        switch (images[i]) {
        	...
        	case 'telescope1': T1 = img; break;
        	case 'telescope2': T2 = img; break;
        	case 'telescope3': T3 = img; break;
        	case 'telescope4': T4 = img; break;
